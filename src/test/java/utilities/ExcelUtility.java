...
public class ExcelUtility {
    ...
    public static void exceleYaz(Scenario scenario, String time, String browser) {
        String path = "src/main/resources/newExcel2.xlsx";
    ...
    public static void main(String[] args) {
        ...
        gelenList = getListData("src/main/resources/ApacheExcel1.xlsx", "testCitizen", 10); // normalde satirda en fazla 6 data var ama biz 10 sutun almasini stedigimiz icin yukaridaki kontrol satirinda 6 ya dusecek.
        System.out.println(gelenList);
